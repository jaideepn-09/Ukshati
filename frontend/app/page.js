...
export default function Home() {
  ...
  const handleHelpClick = () => {
    window.location.href = `mailto:jaideepn3590@duck.com?subject=Help`;
  };

  return (
    <div className="overflow-hidden h-screen w-screen fixed">
      {/* Loading Overlay */}
      {loadingProgress < 100 && (
        <div className="fixed inset-0 z-[999999] flex items-center justify-center bg-black/30 backdrop-blur-xl">
      ...
      {/* Main Content */}
      <div 
        className="flex flex-col min-h-screen text-gray-900 p-4 md:p-6 gradient-bg relative"
        style={{
          filter: `blur(${Math.max(20 - (loadingProgress * 0.2), 0)}px)`,
      ...
      >
        ...
        <div className="fixed top-0 left-0 w-full z-50">
          <Navbar className="backdrop-blur-sm py-4 md:py-4 shadow-lg navbar-glow px-2 md:px-4">
            <NavbarBrand>
              <Image 
                src="/lg.png" 
                alt="Ukshati Logo" 
            ...
            <NavbarContent className="hidden sm:flex gap-4 md:gap-6" justify="center">
              <NavbarItem>
                <button onClick={openAboutUs} className="text-sm md:text-base text-blue-400 hover:text-blue-300 transition-colors">
                  About Us
                </button>
              </NavbarItem>
              <NavbarItem>
                <button onClick={handleHelpClick} className="text-sm md:text-base text-blue-400 hover:text-blue-300 transition-colors">
                  Help
                </button>
              </NavbarItem>
            </NavbarContent>
        ...
        {isAboutUsOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-transparent backdrop-blur-md p-4">
            <div className="bg-black/80 p-4 md:p-8 rounded-lg w-full max-w-2xl mx-4 overflow-y-auto max-h-[80vh]">
              <h2 className="text-3xl md:text-5xl font-bold mb-4 text-white">About Us</h2>
              <p className="text-base md:text-xl text-red-400 mb-4">
                At Ukshati Technologies Pvt Ltd, we have created a platform for automating plant watering. 
                Our mission is to simplify watering while reducing water waste.
              </p>
              <p className="text-base md:text-xl text-red-400 mb-4">
                Our customizable solutions work for both large gardens and small balconies. 
                We offer water tank-based systems with optional aesthetic enclosures.
              </p>
              <button 
                onClick={closeAboutUs}
                className="mt-4 px-4 py-2 md:px-6 md:py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors text-sm md:text-base"
              >
                Close
              </button>
            </div>
          ...
          <div className="bg-gradient-to-br from-green-200/50 via-green-400 to-transparent backdrop-blur-sm p-4 md:p-16 rounded-lg shadow-lg text-center w-full max-w-md relative min-h-[300px] md:min-h-[400px] border border-white/20 group">
            ...
            >
              ...
              <div className="icon-2">
                <svg className="w-full h-full" viewBox="0 0 420.62 554.38">
              ...
              <div className="icon-3">
                <svg className="w-full h-full" viewBox="0 0 313.64 405.79">
              ...
              <div className="icon-4">
                <svg className="w-full h-full" viewBox="0 0 359.65 724.72">
        ...
        <style jsx global>{`
          ...
          @keyframes inIcon1 {
            ...
            65% { transform: translate(-50%, 0) rotate(3deg); }
          ...
          @keyframes inIcon2 {
            0% { transform: translate(-50%, 0) rotate(0deg); }
            35% { transform: translate(-50%, 0) rotate(10deg); }
            50% { transform: translate(-50%, 0) rotate(4deg); }
            80% { transform: translate(-50%, 0) rotate(5deg); }
            100% { transform: translate(-50%, 0) rotate(0deg); }
          }
          ...
          @keyframes inIcon3 {
            0% { transform: translate(-50%, 0) rotate(0deg); }
            35% { transform: translate(-50%, 0) rotate(-2deg); }
            100% { transform: translate(-50%, 0) rotate(0deg); }
          }
          ...
          @keyframes inIcon5 {
            0% { transform: translate(-50%, 0) rotate(0deg); }
            35% { transform: translate(-50%, 0) rotate(-3deg); }
            100% { transform: translate(-50%, 0) rotate(0deg); }
          }

          .fil-leaf-1 { fill: #7B9B3A }
          .fil-leaf-2 { fill: #556729 }
